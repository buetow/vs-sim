...
\begin{itemize}
	...
	\item \textit{public boolean equals(VSMessage message)}: Hiermit l\"{a}ﬂt sich \"{u}berpr\"{u}fen, ob eine gegebene Nachricht die selbe Nachrichten-ID besitzt (es sich um die selbe Nachricht handelt).
\end{itemize}
